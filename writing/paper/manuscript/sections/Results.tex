...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    ...
    \caption{GLM contrast between real and virtual conditions which shows the differences in activation between the two conditions.}
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    ...
    \caption{Functional connectivity results for the contrast between real and virtual conditions.}
    \label{fig:fc_real_vs_virtual}
  \end{subfigure}
  \caption{In (a), red signifies that condition 1 (real faces) has more activation in that area than condition 2 (virtual faces), while blue signifies that condition 2 (virtual faces) has more activation than condition 1 (real faces).
      ...
      In (b), the thickness of the lines represents the difference in the count of significantly different channel pairs between the two conditions. 
...
Next we sought to explore higher-order patterns in brain regions connectivity. 
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{C:/Users/super/OneDrive - Ontario Tech University/fNIRS_Emotions/plots/spectral_connectivity_time/emotion_analysis/face_type_by_emotion_contrast_barplot.png}
  \caption{A bar plot summary of the functional connectivity results for the count of significantly different channel pairs for each emotion, separated by face type (real vs. virtual).}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{C:/Users/super/OneDrive - Ontario Tech University/fNIRS_Emotions/plots/spectral_connectivity_time/emotion_analysis/face_type_by_emotion_region_contrast_barplot.png}
  \caption{A bar plot summary of the functional connectivity results for the count of significantly different channel pairs for each region, separated by face type (real vs. virtual), summarized across all emotions.}
