...
Since each block of faces was either all real or all virtual, and all had the same emotional expression (as discussed in \ref{fig:paradigm}), each y/n response was labeled with Face type and Emotion.
