...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item 88 participants completed the experiment, but only 53 participants were included after excluding those with poor data quality.
        ...
        \item The 53 participants ranged in age from 17-51 years old, with a mean age of 22 years, and 39/53 were female. 
    \end{itemize}
    \note[frame]{
        \begin{itemize}
            ...
            \item A total number of 88 participants completed the experiment, but only 53 participants were included in the fNIRS analysis after excluding those with poor data quality.
            \item We used thresholds common in fNIRS research such as the Scalp Coupling Index (SCI) to determine the quality of the data.
            \item In terms of demographics, the 53 participants ranged in age from 17-51 years old, with a mean age of 22 years, and 39 out of 53 were female. 
        \end{itemize}
    }
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{C:/Users/super/OneDrive - Ontario Tech University/fNIRS_Emotions/plots/spectral_connectivity_time/emotion_analysis/Count_of_Significant_Channel_Pairs_by_Emotion.png}
    \end{figure}
    \begin{itemize}
        \small
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.75\textwidth]{C:/Users/super/OneDrive - Ontario Tech University/fNIRS_Emotions/plots/spectral_connectivity_time/emotion_analysis/Count_of_Significant_Channel_Pairs_by_Region.png}
    \end{figure}
    \begin{itemize}
        \small
