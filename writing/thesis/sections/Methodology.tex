...
The intensity of the emotional expressions were matched as well across both datasets in a separate task (see Appendix \ref{fig:appendix_emotion_expression_similarity}).
