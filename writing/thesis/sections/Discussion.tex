...
A preliminary behavioural experiment confirmed that the emotional expressions of the two datasets were matched in intensity (Appendix \ref{fig:appendix_emotion_expression_similarity}).
